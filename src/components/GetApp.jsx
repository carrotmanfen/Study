    ...
    <section className='flex justify-center items-center mt-16'>
        <div className='flex flex-col sm:flex-row-reverse justify-center items-center sm:max-w-[696px] md:max-w-[960px] lg:max-w-[1140px] sm:mt-16'>
            ...
            <h2 className='text-white font-normal font-roboto text-[20px] mb-6 text-center sm:text-left'>GET OUR APP</h2>
                <h1 className='text-white font-outfit font-semibold text-[36px] sm:text-[44px] md:text-[60px] sm:leading-[50px] md:leading-[60px] text-center sm:text-left mb-6'>browse NFTs from your smartphone</h1>
                ...
                <Button text={'DOWNLOAD ON IOS'} styles={' sm:px-6 sm:w-[300px]'}/>
            </div>
        </div>
    </section>
  )
