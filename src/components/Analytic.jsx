    ...
    <section className='flex justify-center items-center'>
        <div className='flex flex-col sm:flex-row justify-center items-center sm:max-w-[696px] md:max-w-[960px] lg:max-w-[1140px] sm:mt-16'>
            ...
            <div className='flex flex-col '>
                ...
                <h1 className='text-white font-outfit font-semibold text-[28px] sm:text-[44px] md:text-[60px] sm:leading-[50px] md:leading-[60px] text-center sm:text-left mb-6'>built-in analytics to track your NFTs</h1>
                ...
                <Button text={'VIEW OUR PRICING'} styles={'mx-6 sm:mx-0 sm:px-6 sm:w-[300px]'}/>
            </div>
        </div>
    </section>
  )
